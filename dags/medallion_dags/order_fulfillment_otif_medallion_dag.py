            ...
            if fulfillment_uri
                ...
                [
                    (
                        "F-1001",
                        "O-1001",
                        f"{run_date}T09:00:00Z",
                        f"{run_date}T11:00:00Z",
                        10,
                    ),
                    (
                        "F-1002",
                        "O-1002",
                        f"{run_date}T10:00:00Z",
                        f"{run_date}T14:00:00Z",
                        6,
                    ),
                ],
...
def silver_order_lifecycle(run_date: str) -> None:
    ...
    try:
        ...
        orders = (
            spark.read.parquet(RUNTIME.path("bronze", run_date, "orders"))
            .select(
                "order_id",
                "customer_id",
                "warehouse_id",
